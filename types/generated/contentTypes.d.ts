...
export interface ApiAfricaRidePlanAfricaRidePlan
  extends Struct.SingleTypeSchema {
  collectionName: 'africa_ride_plans';
  info: {
    displayName: 'Africa Ride Plan';
    pluralName: 'africa-ride-plans';
    singularName: 'africa-ride-plan';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    budgetSummary: Schema.Attribute.RichText & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cta: Schema.Attribute.Relation<'oneToOne', 'api::cta-config.cta-config'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::africa-ride-plan.africa-ride-plan'
    > &
      Schema.Attribute.Private;
    mediaStrategy: Schema.Attribute.RichText & Schema.Attribute.Required;
    overview: Schema.Attribute.RichText & Schema.Attribute.Required;
    projectedCountries: Schema.Attribute.JSON &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<[]>;
    proposalAsset: Schema.Attribute.Relation<
      'oneToOne',
      'api::download-asset.download-asset'
    >;
    publishedAt: Schema.Attribute.DateTime;
    ...
    >;
    sponsorTiers: Schema.Attribute.Relation<
      'oneToMany',
      'api::sponsor-tier.sponsor-tier'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiAwardAward extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    awardedAt: Schema.Attribute.Date & Schema.Attribute.Required;
...
export interface ApiCtaConfigCtaConfig extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Reusable CTA definitions';
    displayName: 'CTA Config';
    pluralName: 'cta-configs';
    singularName: 'cta-config';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    destinationType: Schema.Attribute.Enumeration<
      ['internal', 'external', 'download', 'payment']
    > &
      Schema.Attribute.Required;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::cta-config.cta-config'
    > &
      Schema.Attribute.Private;
    placement: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    trackingEventName: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiDownloadAssetDownloadAsset
  extends Struct.CollectionTypeSchema {
  collectionName: 'download_assets';
  info: {
    displayName: 'Download Asset';
    pluralName: 'download-assets';
    singularName: 'download-asset';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    accessPolicy: Schema.Attribute.Enumeration<
      ['public', 'gated', 'signed_url']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'public'>;
    asset: Schema.Attribute.Media<'files'> & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    publishedAtExternal: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<
      ['sponsorship_deck', 'report', 'media_kit', 'other']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiFinancialSummaryFinancialSummary
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    expenseSummary: Schema.Attribute.RichText & Schema.Attribute.Required;
    incomeSummary: Schema.Attribute.RichText & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    reportAsset: Schema.Attribute.Media<'files'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiGovernanceRecordGovernanceRecord
  extends Struct.SingleTypeSchema {
  collectionName: 'governance_records';
  info: {
    displayName: 'Governance Record';
    pluralName: 'governance-records';
    singularName: 'governance-record';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    accountabilityStatement: Schema.Attribute.RichText &
      Schema.Attribute.Required;
    boardOverview: Schema.Attribute.RichText & Schema.Attribute.Required;
    cboRegistrationNumber: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::governance-record.governance-record'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    supportingAssets: Schema.Attribute.Media<'files' | 'images', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    bioSnapshot: Schema.Attribute.RichText & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    emailCaptureHeadline: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Ride With The Mission.'>;
    ...
    heroSubline: Schema.Attribute.Text & Schema.Attribute.Required;
    impactMetrics: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    primaryCta: Schema.Attribute.Relation<
      'oneToOne',
      'api::cta-config.cta-config'
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    secondaryCta: Schema.Attribute.Relation<
      'oneToOne',
      'api::cta-config.cta-config'
    >;
    seoMeta: Schema.Attribute.Relation<
      ...
      'api::seo-page-meta.seo-page-meta'
    >;
    sponsorshipSection: Schema.Attribute.RichText & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiImpactMetricImpactMetric
  extends Struct.CollectionTypeSchema {
  collectionName: 'impact_metrics';
  info: {
    displayName: 'Impact Metric';
    pluralName: 'impact-metrics';
    singularName: 'impact-metric';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    evidenceAsset: Schema.Attribute.Media<'images' | 'files'>;
    key: Schema.Attribute.UID<'label'> & Schema.Attribute.Required;
    label: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiLeadEventLeadEvent extends Struct.CollectionTypeSchema {
  collectionName: 'lead_events';
  info: {
    displayName: 'Lead Event';
    pluralName: 'lead-events';
    singularName: 'lead-event';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    crmProvider: Schema.Attribute.String;
    crmRecordId: Schema.Attribute.String;
    email: Schema.Attribute.Email & Schema.Attribute.Required;
    fullName: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::lead-event.lead-event'
    > &
      Schema.Attribute.Private;
    ...
    source: Schema.Attribute.Enumeration<
      ['sponsor', 'donor', 'newsletter', 'contact', 'speaker_invite']
    > &
      Schema.Attribute.Required;
    syncError: Schema.Attribute.Text;
    syncStatus: Schema.Attribute.Enumeration<['pending', 'synced', 'failed']> &
      Schema.Attribute.Required &
...
export interface ApiMediaMentionMediaMention
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    logoAsset: Schema.Attribute.Media<'images'>;
    publishedAt: Schema.Attribute.DateTime;
    publishedAtSource: Schema.Attribute.DateTime & Schema.Attribute.Required;
    publisher: Schema.Attribute.String & Schema.Attribute.Required;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<
      ['press', 'tv', 'radio', 'podcast', 'digital']
    > &
      Schema.Attribute.Required &
...
export interface ApiPartnerLogoPartnerLogo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['corporate', 'media', 'ngo', 'government', 'other']
    > &
      Schema.Attribute.Required &
    ...
    > &
      Schema.Attribute.Private;
    logoAsset: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    bodyRichText: Schema.Attribute.RichText & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cta: Schema.Attribute.Relation<'oneToOne', 'api::cta-config.cta-config'>;
    galleryAssets: Schema.Attribute.Media<'images', true>;
    heroAsset: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::project.project'
    ...
    slug: Schema.Attribute.UID<'title'> &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    status: Schema.Attribute.Enumeration<['planning', 'active', 'completed']> &
      Schema.Attribute.Required &
...
export interface ApiRiderProfileRiderProfile extends Struct.SingleTypeSchema {
  ...
  attributes: {
    countiesCompleted: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<47>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    journeySince: Schema.Attribute.Date & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::rider-profile.rider-profile'
    > &
      Schema.Attribute.Private;
    philosophy: Schema.Attribute.RichText & Schema.Attribute.Required;
    portraitAssets: Schema.Attribute.Media<'images', true>;
    publishedAt: Schema.Attribute.DateTime;
    ridingToAccessNarrative: Schema.Attribute.RichText &
      Schema.Attribute.Required;
    seoMeta: Schema.Attribute.Relation<
      'oneToOne',
      'api::seo-page-meta.seo-page-meta'
...
export interface ApiSeoPageMetaSeoPageMeta extends Struct.CollectionTypeSchema {
  collectionName: 'seo_page_metas';
  info: {
    description: 'SEO metadata per page';
    displayName: 'SEO Page Meta';
    pluralName: 'seo-page-metas';
    singularName: 'seo-page-meta';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSponsorTierSponsorTier extends Struct.CollectionTypeSchema {
  collectionName: 'sponsor_tiers';
  info: {
    displayName: 'Sponsor Tier';
    pluralName: 'sponsor-tiers';
    singularName: 'sponsor-tier';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    benefits: Schema.Attribute.JSON &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<[]>;
    brandExposure: Schema.Attribute.JSON &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<[]>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::impact-metric.impact-metric': ApiImpactMetricImpactMetric;
      'api::lead-event.lead-event': ApiLeadEventLeadEvent;
